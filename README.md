...
Aplicación de escritorio en **Python (Tkinter + ttk)** para automatización documental con ejecución de scripts desde una interfaz única.

## Funcionalidades principales

- Operaciones con **PDF** (unir, extraer páginas, rotar, numerar, renombrar, etc.)
- Conversión/procesado de **EML**
- Procesado de **MBOX**
- Utilidades de renombrado y automatización de tareas documentales
- Interfaz modular por pestañas (UI) y ejecución de procesos
